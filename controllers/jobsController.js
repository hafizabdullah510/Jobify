...
export const deleteJob = async (req, res) => {
  ...
  //check wether the user updating has the same id as job created by id
...
export const getAllJobs = async (req, res) => {
  ...
  // remove await here as there will be different conditions for getting jobs
  let result = Job.find(queryObject);

  //we want to sort the results we get
  if (sort === "latest") {
...
export const showStats = async (req, res) => {
  ...
  //default values if there are no jobs
  let defaultStats = {
